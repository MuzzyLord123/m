...
export const photos = {
  ...
  stairsNavy: photo(
    'interior-stairs-navy-panelling',
    1536,
    1536,
    'interior',
    'Stairs with navy panelling',
    'A staircase seen from the landing: white spindles and an oak rail above navy-painted panelling down both sides',
  ),
  landingNavy: photo(
    'interior-landing-navy-panelling',
    1536,
    1536,
    'interior',
    'Landing, navy panelling below the rail',
    'A landing with navy-painted panelling beneath a white balustrade and oak handrail, and wood flooring',
  ),
  entranceHall: photo(
    ...
    720,
    'interior',
    'Entrance hall under an arched window',
    'A bright entrance hall with an arched window over the front door, a white staircase and a tiled floor',
  ),
  hallStairs: photo(
    'interior-hall-stairs-oak-rail',
    720,
    720,
    'interior',
    'Hall and stairs, white and oak',
    'A hall and staircase with white spindles and an oak handrail, looking through to the kitchen',
  ),
  loungePrep: photo(
    'interior-lounge-prep',
    720,
    720,
    'interior',
    'Lounge, sofa wrapped and walls prepared',
    'A lounge mid-job: the sofa wrapped in plastic, the floor sheeted and the walls made good before painting',
  ),
  landingOak: photo(
