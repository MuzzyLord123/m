 ...
 */
export function Contact({ showHead = true }: { showHead?: boolean } = {}) {
  return (
    <section
      id="contact"
      aria-labelledby={showHead ? 'contact-heading' : undefined}
      aria-label={showHead ? undefined : 'Contact'}
      className="bg-green text-chalk"
    >
