    ...
    <Layout>
      <section className="section-padding pt-32">
        <div className="container-tight">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="p-4 text-center bg-primary/10"><span className="text-primary font-display">Quooro</span></th>
                  <th className="p-4 text-center">Typical Agency</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="text-center mt-16"><Button variant="premium" size="xl" asChild><Link to="/get-started">Get Started Today <ArrowRight className="w-4 h-4" /></Link></Button></div>
        </div>
      </section>
    </Layout>
  );
