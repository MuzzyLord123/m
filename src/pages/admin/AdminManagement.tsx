...
import { ArrowLeft, Shield, Plus, Trash2, Loader2, Crown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="h-14 border-b border-border flex items-center gap-2 px-4">
        <Button variant="ghost" size="sm" onClick={() => navigate(portalHome)}>
          <ArrowLeft className="h-4 w-4 mr-1.5" /> Back
        </Button>
        <Shield className="h-4 w-4 text-primary ml-2" />
        <h1 className="font-semibold">Admin Accounts</h1>
