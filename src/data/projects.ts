...
export const projects: Project[] = [
  {
    ...
    featured: true,
    images: [
      img("/work/kitchen-extension-01.jpg", "Open-plan kitchen and diner with a vaulted ceiling, roof lights and black sliding doors to the garden", "3:4", "#8b847b"),
      img("/work/kitchen-extension-02.jpg", "The same room looking back, showing the angled ceiling reveals and wall uplighters", "3:4", "#99938e"),
      img("/work/kitchen-extension-03.jpg", "The extension before decoration, with sliding doors fitted and the floor still bare", "4:3", "#838776"),
      img("/work/kitchen-extension-04.jpg", "Bare plaster and dust sheets before the first coat went on", "3:4", "#9e9385"),
      img("/work/kitchen-extension-05.jpg", "The extension at its earliest — bare pink plaster, sliders in, garden beyond", "4:3", "#848273"),
      img("/work/kitchen-extension-06.jpg", "The finished open-plan room from the far end, kitchen and seating together", "4:3", "#8c8780"),
    ],
    beforeAfter: {
      before: img("/work/kitchen-extension-04.jpg", "The extension in bare plaster, dust sheets down, before any paint", "3:4", "#9e9385"),
      after: img("/work/kitchen-extension-02.jpg", "The same space finished, with the vaulted ceiling and reveals cut in by hand", "3:4", "#99938e"),
    },
  },
  {
    ...
    featured: true,
    images: [
      img("/work/open-plan-kitchen-01.jpg", "Open-plan kitchen with a vaulted ceiling, roof light and bifold doors, decorated around the fitted units", "4:3", "#867a6b"),
    ],
  },
  {
    slug: "alcove-joinery",
    ...
    featured: true,
    images: [
      img("/work/alcove-joinery-01.jpg", "Finished alcove shelving either side of a chimney breast, painted in a soft grey-green", "4:3", "#71655d"),
      img("/work/alcove-joinery-02.jpg", "The same alcoves in bare timber and ply before filling and painting", "4:3", "#a8866e"),
    ],
    beforeAfter: {
      before: img("/work/alcove-joinery-02.jpg", "Alcove units in bare timber and ply, chimney breast in fresh plaster", "4:3", "#a8866e"),
      after: img("/work/alcove-joinery-01.jpg", "The finished units and breast, filled, primed and finished in eggshell", "4:3", "#71655d"),
    },
  },
  {
    slug: "new-staircase",
    ...
    featured: true,
    images: [
      img("/work/new-staircase-01.jpg", "Finished hallway with the staircase painted white, oak floor and front door beyond", "3:4", "#78746f"),
      img("/work/new-staircase-02.jpg", "The staircase in bare pine before any paint, with the ceiling still to be made good", "3:4", "#917f69"),
      img("/work/new-staircase-03.jpg", "Mid-decoration, with the balustrade painted and the treads still bare", "3:4", "#86857e"),
    ],
    beforeAfter: {
      before: img("/work/new-staircase-02.jpg", "The staircase in bare pine, knots unsealed, before any paint", "3:4", "#917f69"),
      after: img("/work/new-staircase-01.jpg", "The same stairs finished in white, with the hallway decorated around them", "3:4", "#78746f"),
    },
  },
  {
    ...
    featured: true,
    images: [
      img("/work/landing-balustrade-01.jpg", "Landing balustrade finished in a dark satin, running along the stairwell", "3:4", "#86776a"),
      img("/work/landing-balustrade-02.jpg", "The same balustrade in bare pine, butted against the old painted newel post", "3:4", "#9e9285"),
    ],
    beforeAfter: {
      before: img("/work/landing-balustrade-02.jpg", "New pine spindles and handrail, unpainted, beside the old white newel", "3:4", "#9e9285"),
      after: img("/work/landing-balustrade-01.jpg", "The finished run in dark satin, new and old timber reading as one piece", "3:4", "#86776a"),
    },
  },
  {
    ...
    featured: true,
    images: [
      img("/work/panelled-hallway-01.jpg", "Hallway with white panelling, herringbone floor, a black console and framed photographs", "3:4", "#737070"),
      img("/work/panelled-hallway-02.jpg", "The staircase with a grey runner and black pipe handrail against the panelled wall", "3:4", "#79797a"),
      img("/work/panelled-hallway-03.jpg", "Looking down over the panelled walls to the black front door and herringbone floor", "3:4", "#7a706b"),
    ],
  },
  {
    ...
    images: [
      img("/work/stairs-colour-01.jpg", "Staircase and understairs cupboards finished in a mid grey, with grey carpet", "3:4", "#837e76"),
      img("/work/stairs-colour-02.jpg", "Two flights with the balustrade finished in near-black against pale walls", "3:4", "#7b746d"),
      img("/work/stairs-colour-03.jpg", "White balustrade above grey-green panelled understairs joinery", "3:4", "#75685a"),
      img("/work/stairs-colour-04.jpg", "The near-black balustrade carried up over two levels, against cream walls", "3:4", "#7f7367"),
      img("/work/stairs-colour-05.jpg", "A staircase part-way through: balustrade finished in white, treads stripped back and waiting", "3:4", "#8e7763"),
    ],
  },
  {
    ...
    images: [
      img("/work/halls-01.jpg", "Hallway in warm grey with an oak floor and a run of framed photographs", "3:4", "#938472"),
      img("/work/halls-02.jpg", "Hall and stairs with a dark stained floor, striped runner and gallery wall", "3:4", "#66635b"),
      img("/work/halls-03.jpg", "Stairs and hallway in a soft olive with white balustrade and understairs panelling", "3:4", "#877d6b"),
      img("/work/halls-04.jpg", "A hallway part-way through: new stairs still in bare timber, panelling in green, sheets down", "4:3", "#6c5d50"),
      img("/work/halls-05.jpg", "Traditional hallway with cream spindles, panelled understairs and an oak console", "4:3", "#6b5a48"),
      img("/work/halls-06.jpg", "Bright hallway with a panelled dado, dark wood floor and an arched opening to the front door", "3:4", "#8e7057"),
      img("/work/halls-07.jpg", "Hallway finished entirely in white, down to the painted floorboards", "3:4", "#88827b"),
    ],
  },
  {
    ...
    featured: true,
    images: [
      img("/work/exterior-01.jpg", "Rendered semi finished in off-white with black bargeboards, fascias and a teal front door", "3:4", "#92887d"),
      img("/work/exterior-02.jpg", "Rendered frontage in white with black bay surrounds and window detailing", "4:3", "#6a7a85"),
      img("/work/exterior-03.jpg", "White render with black bay surrounds and an arched porch", "4:3", "#8b8885"),
      img("/work/exterior-04.jpg", "Close detail of a bay window with the surrounds and sills freshly cut in black", "3:4", "#768493"),
      img("/work/exterior-05.jpg", "Rendered bungalow in off-white with black fascias, soffits and garage doors", "4:3", "#6d7673"),
    ],
  },
  {
    ...
    duration: "3 weeks",
    images: [
      img("/work/commercial-01.jpg", "Commercial unit part-way through decoration, suspended ceiling in and screed floor down", "4:3", "#958e85"),
    ],
  },
  {
    slug: "feature-walls",
    ...
    images: [
      img("/work/feature-01.jpg", "Dining room with an ochre feature wall behind a framed print", "3:4", "#968970"),
      img("/work/feature-02.jpg", "A near-black feature wall going on between two oak doors, dust sheets down", "4:3", "#82746c"),
      img("/work/feature-03.jpg", "Kitchen with a lime green feature wall against cream gloss units", "3:4", "#69614e"),
    ],
  },
];
