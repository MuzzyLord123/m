/**
 * Client-side wireframe generation logic.
 * Deterministic, keyword-based — no AI/API needed.
 */
...
interface PageTemplate { name: string; slug: string; }
...
export function generateWireframes(prompt: string, pageCount: number, sectionIds: string[]): GeneratedPage[] {
