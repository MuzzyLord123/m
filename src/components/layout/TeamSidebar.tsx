...
{ id: 'leads', label: 'Leads', icon: Target, tab: 'leads', path: '/dashboard?tab=leads' },
...
{ id: 'subscription-sites', label: 'Subscription Websites', icon: Globe, tab: 'subscription-sites', path: '/team/subscription-websites' },
{ id: 'hosted-sites', label: 'Hosted Websites', icon: Server, tab: 'hosted-sites', path: '/team/hosted-websites' },
