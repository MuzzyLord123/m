      ...
      <div className="shell">
        <div className="grid items-end gap-y-10 lg:grid-cols-[1.06fr_0.94fr] lg:gap-x-12">
          ...
          <div className="relative z-10 lg:pb-10">
            ...
            <HeroHeadline
              /* The column narrows at lg when the photograph takes its half, so
                 the display size steps back down there to hold two lines. */
              className="mt-6 font-display text-[3.25rem] leading-[1] font-semibold tracking-[-0.035em] text-ink sm:text-[4.25rem] lg:text-[3.5rem] xl:text-[4.5rem] 2xl:text-[5.25rem]"
              lines={[
                "Decorating,",
